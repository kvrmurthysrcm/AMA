...
public class AnalyticsFilterRequest {
    ...
    @Valid
    private DateRangeDto compareDateRange;
    ...
    public DateRangeDto getCompareDateRange() { return compareDateRange; }
    public void setCompareDateRange(DateRangeDto compareDateRange) { this.compareDateRange = compareDateRange; }
